...
Setup
Import the provided .sql file into a MySQL environment.

Configure the application connection strings to point to the local database instance.

Deploy the source files to a compatible web server environment.
